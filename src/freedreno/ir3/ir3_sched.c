...
should_defer(struct ir3_sched_ctx *ctx, struct ir3_instruction *instr)
{
    ...
    */
   /* A618-OPT: Reduced outstanding SY/SS limit from 8 to 6 to mitigate
    * register pressure on Adreno 618 (A6xx). The A618 has a limited register
    * file; reducing the in-flight texture/SFU window avoids register spill.
    */
