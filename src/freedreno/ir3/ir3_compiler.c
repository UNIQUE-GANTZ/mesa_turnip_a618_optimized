                    ...
                    const struct ir3_compiler_options *options)
{
    ...
    * This allows the NIR optimizer to propagate FP16 types through I/O
    * operations, reducing register pressure and improving throughput.
    * nir_io_16bit_input_output_support enables 16-bit varying I/O paths.
    */
